    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    redirect('edit_ssale.php?id='.$sale['id'], false);
                  } else {
                    $session->msg('d',' Sorry failed to updated!');
                    redirect('ssales.php', false);
                  }
        } else {
           $session->msg("d", $errors);
           redirect('edit_ssale.php?id='.(int)$sale['id'],false);
        }
  }
         ...
         <thead>
          ...
          <th> Action</th>
           ...
           <tbody  id="product_info">
              <tr>
              <form method="post" action="edit_ssale.php?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_name">
