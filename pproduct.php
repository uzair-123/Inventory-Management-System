      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
         <div class="pull-right">
           <a href="add_pproduct.php" class="btn btn-primary nam">Add New</a>
         </div>
        </div>


  <input class="nam" type="text" id="myInputs" onkeyup="myFunction()" placeholder="Search for names..">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_pproduct.php?id=<?php echo (int)$product['id'];?>" class="btn btn-info btn-xs"  title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a href="delete_pproduct.php?id=<?php echo (int)$product['id'];?>" class="btn btn-danger btn-xs"  title="Delete" data-toggle="tooltip">
