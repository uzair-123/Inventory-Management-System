      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <strong>
            ...
            <span>VIEW GODOWN SALES</span>
          </strong>
          <div class="pull-right">
            <a href="add_ssales.php" class="btn btn-primary">Add sale</a>
          </div>
        </div>
           ...
           <tbody>
             ...
             <tr>
               <td class="text-center"><?php echo $sale['bno'] ;?></td>
                  <td><?php echo remove_junk($sale['cust']); ?></td>
               ...
               <td class="text-center">
                  <div class="btn-group">
                     <a href="edit_ssale.php?id=<?php echo (int)$sale['id'];?>" class="btn btn-warning btn-xs"  title="Edit" data-toggle="tooltip">
                       <span class="glyphicon glyphicon-edit"></span>
                     </a>
                     <a href="delete_ssale.php?id=<?php echo (int)$sale['id'];?>" class="btn btn-danger btn-xs"  title="Delete" data-toggle="tooltip">
